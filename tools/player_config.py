...
DEFAULTS = dict(display_mode='0', motion_interpolation='0', gdi='', native_mod='', rhythm_offset_ms='0', volume='100', audio_buffer_ms='64', texture_packs='0', fullscreen='0', window_scale='1', vsync='0')
